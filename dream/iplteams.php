  ...
  line-height: 1.5;
    ...
    $(document).ready(function(){
		...
		<div class="navi-slot">
			...
			<ul class="menu-items">
				<li class="sub"><a>Matches</a>
					<ul class="menu-items sub-menu">
						...
						<li class="active"><a href="iplteams.php">IPL</a></li>
					</ul>
				</li>
            ...
            echo"<p>";
                echo '<form action="setplayer2.php" method="post">';
                
                while($row=mysqli_fetch_assoc($result)){
                    echo '<input type="checkbox"  name='.$row['ipl_id'].' value='.$row['ipl_id'].'/>';
